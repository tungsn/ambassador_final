...
$(document).ready(function () {
	...
	ddlCourse.on('change', function(){
		...
		if (valueCourse == 0) {
			$(ambassadorList).each(function () {
				var colorSetterCourse = buildColorSetter(this.countryCode, "#274591");
	...
	ddlYear.on('change', function(){
		...
		if (valueYear == 0) {
			$(ambassadorList).each(function () {
				var colorSetterYear = buildColorSetter(this.countryCode, "#274591");
				vmap.vectorMap("set", "colors", colorSetterYear);
			});
		}
